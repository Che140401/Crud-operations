...
function list() {
    ...
    for (var i = 0; i < listItem.length; i++) 
    {
            ...
            strlist += "<tr id='table_data'>" +
                ...
                "<td id='actions'><button type='button' class='btn btn-primary mx-2' id='edit_btn' data-toggle='modal' data-target='.bd-example-modal-lg' onclick='editbutton("+(listItem[i].Roll_No)+")'>Edit</button><button type='button' class='btn btn-primary' onClick='deleteButton("+listItem[i].Roll_No+")'>Delete</button></td>" +
                "</tr>"
    }
